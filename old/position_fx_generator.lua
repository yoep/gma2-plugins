...
function create_block_cues_position(sequence)
    create_cue(sequence, 0, "OFF", string.format("Assign Effect %i /blocks=0; %s", _G.effect_index_position, create_cue_cmd_executor_off(_G.executor_blocks_index_position)));
...
function create_wing_cues_position(sequence)
    create_cue(sequence, 0, "OFF", string.format("Assign Effect %i /wings=0; %s", _G.effect_index_position, create_cue_cmd_executor_off(_G.executor_wings_index_position)));
